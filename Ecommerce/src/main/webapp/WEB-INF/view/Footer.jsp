...
<h3>JUST 5 MIN </h3>
 <ul> <li> <a href="resource/images/himani.jpg"> WHO I AM  </a> </li> 

 </ul> </div>
  <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
   <h3> My Story </h3> 
   <ul> <li> <a href="story">  My Story </a> </li>
          ...
          <ul> <li> <a href="login">login  </a> </li> 
            ...
            <ul class="social">
             <li> <a href="https://www.facebook.com"> <i class=" fa fa-facebook">   </i> </a> </li>
              ...
              <div class="container"> <p class="pull-left"> Copyright © Footer JUST 5 MIN Plugin 2016. All right reserved. </p> 
